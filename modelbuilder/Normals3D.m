...
% face 1 
nx(fid1, :) = frx(fid1, :)+fsx(fid1, :)+ftx(fid1, :);
ny(fid1, :) = fry(fid1, :)+fsy(fid1, :)+fty(fid1, :);
nz(fid1, :) = frz(fid1, :)+fsz(fid1, :)+ftz(fid1, :);

% face 2
nx(fid2, :) = -frx(fid2, :); ny(fid2, :) = -fry(fid2, :); nz(fid2, :) = -frz(fid2, :);

% face 3
nx(fid3, :) = -fsx(fid3, :); ny(fid3, :) = -fsy(fid3, :); nz(fid3, :) = -fsz(fid3, :);

% face 4 
nx(fid4, :) = -ftx(fid4, :); ny(fid4, :) = -fty(fid4, :); nz(fid4, :) = -ftz(fid4, :);

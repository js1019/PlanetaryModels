...
%-------------------------------------------------------------
fmesh  = '/local/js116/NMmodels/GitTests/Mars/Mars40k/Mars_3L_40k'; 
...
% load unit spheres
load ../../../discontinuities/MarsCrust/workdata/Msurf_5864.mat
p1 = p;
np1 = size(p1,1); t1 = t; nt1 = size(t1,1);


load ../../../discontinuities/MarsCrust/workdata/Mcmi_3616.mat
p2 = p; 
np2 = size(p2,1); t2 = t + np1; nt2 = size(t2,1);


load ../../../discontinuities/MarsEllp/MCMB419/MarsEllp956.mat

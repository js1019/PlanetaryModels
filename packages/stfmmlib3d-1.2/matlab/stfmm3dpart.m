...
[ier, pot, pre, grad] = stfmm3d_r2012a(mex_id_, ier, iprec, nsource, source, ifsingle, sigma_sl, ifdouble, sigma_dl, sigma_dv, ifpot, pot, pre, ifgrad, grad, 1, 1, 1, 3, nsource, 1, 1, 3, nsource, 1, 1);
else
...
[ier, pot, pre, grad, pottarg, pretarg, gradtarg] = stfmm3d_r2012a(mex_id_, ier, iprec, nsource, source, ifsingle, sigma_sl, ifdouble, sigma_dl, sigma_dv, ifpot, pot, pre, ifgrad, grad, ntarget, target, ifpottarg, pottarg, pretarg, ifgradtarg, gradtarg, 1, 1, 1, 3, nsource, 1, 1, 3, nsource, 1, 1, 1, 1, 1);
end

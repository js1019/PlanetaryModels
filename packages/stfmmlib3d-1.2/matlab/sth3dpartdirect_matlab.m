function [U]=sth3dpartdirect_matlab(itype,nsource,source,ifsingle,sigma_sl,ifdouble,sigma_dl,sigma_dv,ifpot,ifgrad,ntarget,target,ifpottarg,ifgradtarg)
%STH3DPARTDIRECT Stokes half space particle interaction in R^3.
%

%
%  Test Stokes particle FMMs in R^3 (half space)
%
...
tic
tic
[U]=sth3dpartdirect(itype,nsource,source,ifsingle,sigma_sl,ifdouble,sigma_dl,sigma_dv,ifpot,ifgrad,ntarget,target,ifpottarg,ifgradtarg);
total_time=toc

'Stokes half-space particle target FMM in R^3 (Matlab)'

tic
[F]=sth3dpartdirect_matlab(itype,nsource,source,ifsingle,sigma_sl,ifdouble,sigma_dl,sigma_dv,ifpot,ifgrad,ntarget,target,ifpottarg,ifgradtarg);
total_time=toc
